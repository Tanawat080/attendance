...
<?php
	...
	{	
		...
		$strSQL = "INSERT INTO teacher (teacherName,teacherLastname,teacherPhone,classID) VALUES ('".$_POST["teacherName"]."', 
		'".$_POST["teacherLastname"]."','".$_POST["teacherPhone"]."','".$_POST["classID"]."')";
		$objQuery = mysqli_query($mysqli,$strSQL);
